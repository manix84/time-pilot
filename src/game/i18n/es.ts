...
const es: typeof en = {
  ...
  menu: {
    ...
    resetAchievements: "Reiniciar achievements",
    resetAllStoredData: "Reiniciar todos los datos",
    resetConfirmTitle: "Confirmar reinicio?",
    resetData: "Reiniciar datos",
    resetWarning: (scope: string) =>
      `Aviso: esto reiniciara ${scope}. No se puede deshacer.`,
    resetWarningAchievements: "achievements",
    resetWarningAllStoredData: "todos los datos guardados de Time Pilot",
    resetWarningPreferences: "preferencias",
    resetWarningScores: "puntuaciones",
    restart: "Reiniciar",
    restartConfirmTitle: "Reiniciar partida?",
