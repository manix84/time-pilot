...
const fr: typeof en = {
  ...
  menu: {
    ...
    highScoreEntryTitle: "Sauver score",
    highScoreName: "Nom",
    highScoreNameHint: "Entre ton nom de pilote",
    ...
    resetAchievements: "Reinitialiser achievements",
    resetAllStoredData: "Reinitialiser toutes les donnees",
    resetConfirmTitle: "Confirmer reset ?",
    resetData: "Reinitialiser donnees",
    resetWarning: (scope: string) =>
      `Attention : ceci reinitialisera ${scope}. Cette action est definitive.`,
    resetWarningAchievements: "les achievements",
    resetWarningAllStoredData: "toutes les donnees Time Pilot",
    resetWarningPreferences: "les preferences",
    resetWarningScores: "les scores",
    restart: "Redemarrer",
    restartConfirmTitle: "Redemarrer le jeu ?",
    resetFilters: "Reset Filters",
    resetPreferences: "Reinitialiser preferences",
    resetScores: "Reinitialiser scores",
    rotate: "Rotation",
    saveScore: "Sauver score",
