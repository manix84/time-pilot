...
const ro: typeof en = {
  ...
  menu: {
    ...
    confirmReset: "Confirma resetarea",
    resetAchievements: "Reseteaza achievements",
    resetAllStoredData: "Reseteaza toate datele",
    resetConfirmTitle: "Confirma resetarea?",
    resetData: "Reseteaza date",
    resetWarning: (scope: string) =>
      `Avertisment: se vor reseta ${scope}. Actiunea nu poate fi anulata.`,
    resetWarningAchievements: "achievements",
    resetWarningAllStoredData: "toate datele Time Pilot salvate",
    resetWarningPreferences: "preferintele",
    resetWarningScores: "scorurile",
    restart: "Restart",
    restartConfirmTitle: "Reincepi jocul?",
    resetFilters: "Reset Filters",
    resetPreferences: "Reseteaza preferinte",
    resetScores: "Reseteaza scoruri",
    rotate: "Rotire",
