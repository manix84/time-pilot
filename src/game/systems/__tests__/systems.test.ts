...
describe("game systems", () => {
  ...
  it("spawns initial props and tick-based entities", () => {
    ...
    expect(context._enemyBullets.create).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        src: "/sounds/enemies/basic/bullet.ogg",
      }),
      undefined,
      undefined
    );
  ...
  it("spawns fast very-slow-homing rockets on level 3", () => {
    ...
    expect(context._enemyBullets.create).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        src: "/sounds/enemies/basic/rocket_launch.ogg",
      }),
      expect.objectContaining({
        src: "/sounds/enemies/basic/rocket_fly.ogg",
      }),
      expect.objectContaining({
        src: "/sounds/enemies/basic/rocket_explode.ogg",
      })
    );
  });
  ...
  it("drops bombs from the 1940 special bomber", () => {
    ...
    expect(context._enemyBullets.create).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        src: "/sounds/enemies/special/bomb.ogg",
      }),
      undefined,
      undefined
    );
