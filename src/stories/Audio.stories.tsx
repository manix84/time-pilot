...
const audioSamples = [
  { label: "Player bullet", path: "sounds/player/bullet.mp3" },
  { label: "Player explosion", path: "sounds/player/explosion.mp3" },
  { label: "Player extra life", path: "sounds/player/extra_life.wav" },
  { label: "Time warp", path: "sounds/player/timewarp.wav" },
  { label: "Enemy bullet", path: "sounds/enemies/basic/bullet.wav" },
  { label: "Enemy explosion", path: "sounds/enemies/basic/explosion.wav" },
  { label: "Rocket explosion", path: "sounds/enemies/basic/rocket_explode.wav" },
  { label: "Rocket launch", path: "sounds/enemies/basic/rocket_launch.wav" },
  { label: "Rocket flying", path: "sounds/enemies/basic/rocket_fly.wav" },
  { label: "Enemy wave start", path: "sounds/enemies/basic/wave_start.wav" },
  { label: "Special bomb", path: "sounds/enemies/special/bomb.wav" },
  { label: "Special explosion", path: "sounds/enemies/special/explosion.wav" },
  { label: "Boss level 1", path: "sounds/enemies/boss/boss1.wav" },
  { label: "Boss level 2", path: "sounds/enemies/boss/boss2.wav" },
  { label: "Boss level 3", path: "sounds/enemies/boss/boss3.wav" },
